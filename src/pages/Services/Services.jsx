  ...
  return (
    <>
        ...
        <div className="container">
          <div className="services-content">
            ...
            <div className="services-buttons">
              <Link to="/contact" className="services-btn primary-service-btn">
                Book Appointment
                <FaArrowRight />
              </Link>

              <Link to="/doctors" className="services-btn secondary-service-btn">
                Meet Our Doctors
              </Link>
            </div>
          ...
          <div className="category-grid">
            ...
            <div className="category-card">
              <div className="category-image">
                <img src={category1} alt="Restore & Replace Services" />
              </div>
              <div className="category-content">
                <span>Restore & Replace</span>
                <h3>Dental Implants, Full Mouth Rehab, Crowns & Bridges</h3>
                <p>
                  Restore missing or damaged teeth using advanced implant dentistry, 
                  crowns and bridges designed for strength, comfort and natural aesthetics.
                </p>
                <Link to="#restore">
                  Explore Treatment
                  <FaArrowRight />
            ...
            <div className="category-card">
              <div className="category-image">
                <img src={category2} alt="Straighten & Align Services" />
              </div>
              <div className="category-content">
                <span>Straighten & Align</span>
                <h3>Invisible Aligners & Dental Braces</h3>
                <p>
                  Correct crowding, spacing and bite issues through digital planning, 
            ...
            <div className="category-card">
              <div className="category-image">
                <img src={category3} alt="Smile Enhancement Services" />
              </div>
              <div className="category-content">
                <span>Enhance Your Smile</span>
                <h3>Smile Makeovers, Teeth Whitening & Veneers</h3>
                <p>
                  Improve colour, symmetry and overall appearance with cosmetic dentistry 
      ...
      <section className="service-detail-section" id="restore">
        <div className="container detail-grid">
          <div className="detail-left">
            <span className="section-tag">RESTORE & REPLACE</span>
            <h2>Restore &<br />Replace</h2>
            <p>
          ...
          <div className="detail-right">
            <div className="detail-card">
              ...
              <p>Permanent replacement for missing teeth using titanium implants.</p>
            </div>
            <div className="detail-card">
              <FaTooth />
              <h3>Full Mouth Rehab</h3>
              <p>Complete rehabilitation for severely worn or damaged teeth.</p>
            </div>
            <div className="detail-card">
              <FaTooth />
              <h3>Crowns & Bridges</h3>
              <p>Strong ceramic restorations designed to match natural teeth.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container detail-grid reverse-grid">
          <div className="detail-right">
            <div className="detail-card">
              ...
              <p>Virtually invisible clear aligners for modern smile correction.</p>
            </div>
            <div className="detail-card">
              <FaTeeth />
              <h3>Metal Braces</h3>
              <p>Reliable orthodontic treatment for every age group.</p>
            </div>
          </div>

          <div className="detail-left">
            <span className="section-tag">STRAIGHTEN & ALIGN</span>
            <h2>Straighten<br />& Align</h2>
            <p>
              Correct crowding, spacing and bite problems through
              digital treatment planning. Every orthodontic case is
              planned for maximum comfort, precision and predictable results.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="service-detail-section" id="smile">
        <div className="container detail-grid">
          <div className="detail-left">
            <span className="section-tag">ENHANCE YOUR SMILE</span>
            <h2>Enhance<br />Your Smile</h2>
            <p>
          ...
          <div className="detail-right three-card">
            ...
            <div className="detail-card">
              ...
              <p>Professional whitening for brighter smiles.</p>
            </div>
            <div className="detail-card">
              <FaMagic />
              <h3>Dental Veneers</h3>
              <p>Ultra-thin porcelain veneers for natural beauty.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="doctor-row">
            <div className="doctor-image">
              <img src={doctor1} alt="Dr. Hazra Portrait" />
            </div>
            <div className="doctor-content">
              ...
              <h4>BDS, MDS</h4>
              <p>
                Gold Medalist Orthodontist specializing in Invisible Aligners, Braces, 
                Smile Makeovers, Jaw Correction and Pediatric Orthodontics. Known for 
                minimally invasive treatment planning and beautiful smile transformations.
              </p>
              <ul>
          ...
          <div className="doctor-row reverse">
            <div className="doctor-content">
              ...
              <h4>BDS, MDS (OMFS)</h4>
              <p>
                Specialist in Dental Implants, Wisdom Tooth Surgery, Laser Surgery 
                and Oral Cancer Screening. Focused on long-term function, precision 
            ...
            <div className="doctor-image">
              <img src={doctor2} alt="Dr. Fida Portrait" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="additional-section">
        <div className="container">
          <div className="additional-heading">
            <span className="section-tag">MORE TREATMENTS</span>
            <h2>Additional Treatments<br />Offered at F&H Dental</h2>
            <p>
        ...
        <div className="container">
          <div className="cta-wrapper">
            <div className="cta-left">
              <span className="section-tag">BOOK YOUR VISIT</span>
              <h2>Ready to Transform<br />Your Smile?</h2>
              <p>
                Whether you need a routine dental check-up, clear aligners, dental 
                implants or a complete smile makeover, our experienced specialists are 
                here to provide personalised treatment with advanced technology and compassionate care.
              </p>
              <div className="cta-buttons">
                ...
                <a href="tel:+917355095660" className="cta-secondary-btn">
                  Call Now
                </a>
              </div>
            </div>
            ...
            <div className="cta-right">
              <div className="contact-card">
                ...
                <p>F&H Aligners & Implant Dental Clinic</p>
                <span>📍 Jamshedpur, Jharkhand</span>
                <span>📞 +91 73550 95660</span>
